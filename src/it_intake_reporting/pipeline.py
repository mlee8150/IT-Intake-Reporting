...
def run_weekly_pipeline(
    ...
    # --- Panel 3: where time goes, and working hours derived from that same table ---
    # Working Hours isn't a separate Jira field — it's Not Started + Review In
    # Progress summed from the same team/status table that feeds the bar chart.
    ...
    working_hours = compute_working_hours(where_time_goes.median_days)
